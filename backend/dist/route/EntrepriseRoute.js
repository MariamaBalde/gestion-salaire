...
entrepriseRouter.post("/", uploadLogo, roleMiddleware(["SUPER_ADMIN"]), (req, res) => entrepriseController.create(req, res));
entrepriseRouter.put("/:id", uploadLogo, roleMiddleware(["SUPER_ADMIN"]), (req, res) => entrepriseController.update(req, res));
